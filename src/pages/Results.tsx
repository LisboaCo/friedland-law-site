  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content="See how Friedland Law has recovered millions for injury victims. Real results, real cases." />
      </Helmet>
      <Header />
      <main>
        <section className="bg-navy py-20">
          <div className="container mx-auto px-4 text-center">
            ...
            <div ref={counterRef} className="text-5xl font-bold text-gold mt-6">${count} Million+ Recovered</div>
          </div>
        </section>
